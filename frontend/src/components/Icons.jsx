...
export const IconEye = I(<><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></>);
export const IconChat = I(<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5Z"/>);
export const IconTrophy = I(<><path d="M8 21h8M12 17v4M7 4h10v4a5 5 0 0 1-10 0V4Z"/><path d="M7 4H4.5A1.5 1.5 0 0 0 3 5.5 3.5 3.5 0 0 0 6.5 9H7M17 4h2.5A1.5 1.5 0 0 1 21 5.5 3.5 3.5 0 0 1 17.5 9H17"/></>);
export const IconFlame = I(<path d="M12 2s4 4 4 8a4 4 0 0 1-8 0c0-1 .5-2 .5-2S8 10 8 12a6 6 0 1 0 8.5-5.5C15 5 12 2 12 2Z"/>);
export const IconClock = I(<><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></>);
export const IconEyeOff = I(<><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c6.5 0 10 7 10 7a13.2 13.2 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.5 13.5 0 0 0 2 12s3.5 7 10 7a9.12 9.12 0 0 0 4.39-1.11"/><path d="M14.12 14.12A3 3 0 1 1 9.88 9.88M1 1l22 22"/></>);
